...
- Пытается выполнить `v8unpack` несколькими поддерживаемыми режимами CLI; если инструмент недоступен/завершился с ошибкой — автоматически применяется fallback на сравнение сырых файлов.
